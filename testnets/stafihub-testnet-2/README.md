...
```shell
stafihubd init YOUR_NODE_NAME --chain-id stafihub-testnet-2
wget -O $HOME/.stafihub/config/genesis.json "https://raw.githubusercontent.com/stafihub/network/main/testnets/stafihub-testnet-2/genesis.json"
